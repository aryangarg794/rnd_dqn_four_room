...
def create_explogostar_dataset(
    ...
    try:
        ...
        while len(explorego) <= dataset_size:
            ...
            print(
                f"Current size of dataset: {len(explorego):08d} | Current Context {current_context} | Current Uniqueness {explorego.ratio_unique_trans:.4f}",
                end="\r",
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-f", "--dir", type=str, default="explore_go_random", help="name of dataset"
    )
