...
from four_room.constants import COLOR_NAMES, DIR_TO_VEC, TILE_PIXELS
from four_room.grid import Grid
from minigrid.core.mission import MissionSpace
from four_room.objects import Point, WorldObj
...
class MiniGridEnv(gym.Env):
    ...
    def get_full_render(self, highlight, tile_size, highlight_mask, colors, agent_col):
        """
